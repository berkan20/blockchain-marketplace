...
contract iotdatamarket {
    ...
    function vendor_register (string memory prefix, uint[] memory sensors, uint[] memory costs) public returns (address add) {
    ...
    function get_vendor (address addr) public view returns (string memory prefix) {
    ...
    function sensor_data_push (address vendor_address, uint sensor_type, string memory schema, uint timestamp, string memory spatial, string memory swarm,uint key_index, uint _encID ) public returns (address) {
    ...
    function sensor_data_pull (address vendor_address, uint sensor_type, uint index) public view returns (string memory schema, uint timestamp, string memory spatial, uint price) {
    ...
    function transfer_key_and_data(string memory dec_key,address _to, uint sensor_type, uint index)public returns(string memory key){
